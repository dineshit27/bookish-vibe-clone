      ...
      <div
        ...
        onMouseLeave={() => {
          ...
          hideTimerRef.current = setTimeout(() => {
            if (!hoveringCardRef.current) setHoverCard(null);
          }, 120);
        }}
      ...
      <AnimatePresence>
        {hoverCard && (
          <motion.div
            ...
            className="brutal-card rounded-lg overflow-hidden bg-background shadow-2xl"
            style={{
              position: "fixed",
              left: hoverCard.x + 16,
          ...
          >
            ...
            <div className="p-3">
              ...
              <Link
                to="/dashboard/books"
                className="border-2 border-foreground bg-foreground text-background rounded-md font-heading text-xs w-full inline-flex items-center justify-center gap-1 px-3 py-2"
